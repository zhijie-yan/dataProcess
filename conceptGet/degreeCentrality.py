...
# 排除一些概念
exclusiveNameStart = ['地质','工程力学','水力学','河流动力学','土力学','岩石力学','给水排水工程','海洋水文学与海岸动力学','港口','航道','河口','海岸','生态水利','水利管理','水利科技']
...
# 调用pageRank
# usePageRank1(relationForArr,relationBackArr)
